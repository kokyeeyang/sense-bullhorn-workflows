...
const configSchema = z.object({
  ...
  CLIENT_CONTACT_DNC_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  PLACEMENT_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  PLACEMENT_DATABASE_ENRICHMENT_DATE_ADDED_QUERY_COUNT: positiveIntWithDefault(200),
  PLACEMENT_DATABASE_ENRICHMENT_DATE_ADDED_TARGET_DATE: optionalString,
  PLACEMENT_DATABASE_ENRICHMENT_CANDIDATE_OWNER_MIN_DATE_ADDED: stringWithDefault("2025-01-01"),
  PLACEMENT_DATABASE_ENRICHMENT_PO_CLIENT_FIELD: stringWithDefault("customText10"),
  PLACEMENT_DATABASE_ENRICHMENT_EVENT_SUBSCRIPTION_ID: stringWithDefault(
    "sense-placement-database-enrichment-sync",
  ),
  PLACEMENT_DATABASE_ENRICHMENT_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  PLACEMENT_TERMINATION_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  INTERVIEW_ILLINOIS_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  JOB_APPLICATION_NOTIFICATION_DRY_RUN_EVENT_SUBSCRIPTION_ID: optionalString,
  ...
  APPROVED_PLACEMENT_APAC_QUERY_COUNT: positiveIntWithDefault(200),
  APPROVED_PLACEMENT_APAC_TARGET_DATE: optionalString,
  AWR_CLIENT_REQUEST_QUERY_COUNT: positiveIntWithDefault(200),
  AWR_CLIENT_REQUEST_TARGET_DATE: optionalString,
  CONTRACTOR_NOT_CONTACTED_QUERY_COUNT: positiveIntWithDefault(200),
  CONTRACTOR_NOT_CONTACTED_TARGET_DATE: optionalString,
  CONTRACTOR_NOT_CONTACTED_LAST_NOTE_DATE_FIELD: stringWithDefault("dateLastComment"),
  CONTRACTOR_NOT_CONTACTED_LAST_NOTE_ACTION_TYPE_FIELD: stringWithDefaultPreserveBlank("customText16"),
  ...
  PAYROLL_NEW_HIRE_GREETING_QUERY_COUNT: positiveIntWithDefault(200),
  PAYROLL_NEW_HIRE_GREETING_TARGET_DATE: optionalString,
  PLACEMENT_END_DATE_REMINDER_QUERY_COUNT: positiveIntWithDefault(200),
  PLACEMENT_END_DATE_REMINDER_TARGET_DATE: optionalString,
  US_CONTRACT_PERFORMANCE_CHECKIN_QUERY_COUNT: positiveIntWithDefault(200),
  US_CLIENT_EXTENSION_NOTIFICATION_QUERY_COUNT: positiveIntWithDefault(200),
  US_CLIENT_EXTENSION_NOTIFICATION_TARGET_DATE: optionalString,
  ...
  FAIR_COLLECTION_NOTICE_QUERY_COUNT: positiveIntWithDefault(200),
  FAIR_COLLECTION_NOTICE_TARGET_DATE: optionalString,
