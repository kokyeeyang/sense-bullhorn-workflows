...
const RULES = [
  ...
  {
    key: "oregon-workplace-fairness-policy",
    source: "dateBegin",
    state: "oregon",
    country: null,
    minimumDateBegin: null,
    ...
    to: "candidate.email",
    cc: [],
    subject: "Oregon Workplace Fairness Policy 2020",
    templatePath: "americas-oregon-workplace-fairness.html",
    attachments: ["attachments/Workplace fairness policy 2020.pdf"],
    requiresSurvey: false,
  },
  {
