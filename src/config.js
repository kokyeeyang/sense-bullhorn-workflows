...
const configSchema = z.object({
  ...
  PLACEMENT_START_REMINDER_DRY_RUN: envBoolean.optional(),
  PLACEMENT_START_REMINDER_USE_TEST_PAYLOAD: envBoolean.default(false),
  PLACEMENT_START_REMINDER_TEST_RECIPIENTS: optionalString,
  ...
  PLACEMENT_TERMINATION_EMAIL_DRY_RUN: envBoolean.optional(),
  PLACEMENT_TERMINATION_EMAIL_USE_TEST_PAYLOAD: envBoolean.default(false),
  PLACEMENT_TERMINATION_TEST_RECIPIENTS: optionalString,
